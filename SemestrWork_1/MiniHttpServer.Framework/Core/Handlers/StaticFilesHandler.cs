...
public class StaticFilesHandler : Handler
{
    ...
    private async Task SendResponse(HttpListenerContext context)
    {
        ...
        //var newPath = context.Request.RawUrl.Split('/').ToList();
        //newPath.RemoveAt(0);
        //if (context.Request.UrlReferrer != null)
        //{
        //    newPath[0] = _SettingsModel.Settings.StaticDirectoryPath;
        //}
        //var searchPath = string.Join("\\", newPath);
        ...
        try // Отправка ответа
        {
            ...
            //Logger.Print($"Запрос обработан. Отправлен файл {path}.");
        }
